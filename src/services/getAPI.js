...
export const getRandomProductList = async () => { // retorna de forma aleatória uma lista de produtos da mesma categoria
  ...
  const secondCall = await fetch( //chama api de produtos por categoria, usando o id de uma categoria aleatória
